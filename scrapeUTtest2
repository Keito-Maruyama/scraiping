...
def extract_data(soup):
    ...
    semester_element = soup.select_one('#catalog-main-container > div.catalog-page-detail-scrollable-container.catalog-horizontal-scrollable-container > div > div > div.catalog-page-detail-table-row.catalog-table-row-in-mylist-2024-40001 > div.catalog-row > div.catalog-page-detail-table-cell.semester-cell > span')
    data['semester'] = semester_element.text.strip() if soup.select_one('#catalog-main-container > div.catalog-page-detail-scrollable-container.catalog-horizontal-scrollable-container > div > div > div.catalog-page-detail-table-row.catalog-table-row-in-mylist-2024-40001 > div.catalog-row > div.catalog-page-detail-table-cell.semester-cell > span') else "学期"
